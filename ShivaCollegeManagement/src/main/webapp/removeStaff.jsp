...
dialog {
 ...
 <%   
		...
		try {
    		...
    		PreparedStatement ps1=con.prepareStatement("select * from faculty where FacultyID=? and Branch=?;");
 			ps1.setString(1, id);
	    ...
	    while(rs.next()) {
			...
			String sub1 =rs.getString("Subject");
			 ...
			 out.print(" <style>\r\n"
		    			...
		    			+ "</style>\r\n"
		    			+ "<h1> Faculty Removed<h1>\r\n"
		    			+ "<table><tr>\r\n"
		    			+ " <td>ID    </td><td> "+id  +"</td> </tr><tr>\r\n"
		    			+ "  <td><label>Designation</label></td><td>"+desig1+"</td> </tr> <tr>\r\n"
	    ...
	    PreparedStatement ps=con.prepareStatement("delete from faculty where FacultyID=? and Branch=?;");
	    ps.setString(1, id);
		ps.setString(2,dprt);
		int x=0;
		x=ps.executeUpdate();
